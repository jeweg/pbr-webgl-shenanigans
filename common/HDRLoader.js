THREE.HDRLoader = function ( manager ) {
...
THREE.HDRLoader.prototype.load = function ( type, url, onLoad, onProgress, onError )
{
    ...
    loader.load(url, function(buffer) {
        ...
        {
            texture = new THREE.DataTexture( texData.data, texData.width, texData.height );
            texture.type = type;
